    ...
    async def _refresh_alerts(self, suppress_new: bool) -> List[dict]:
        ...
        for imp in impacts:
            ...
            alert = {
                ...
                "speed": imp.get("speed_kmh") or 0,
                "injury_probability": imp.get("injury_probability"),
                "triage_level": imp.get("triage_level"),
                "triage_label": imp.get("triage_label"),
                "triage_priority": imp.get("triage_priority"),
                "risk_zone": imp.get("risk_zone"),
                "status": status,
    ...
    async def driver_events(self, driver_id: str, limit: int = 100) -> List[dict]:
        ...
        for e in events:
            ...
            normalised.append({
                ...
                "speed": e.get("speed_kmh") or 0,
                "injury_probability": e.get("injury_probability"),
                "triage_level": e.get("triage_level"),
                "triage_label": e.get("triage_label"),
                "triage_priority": e.get("triage_priority"),
