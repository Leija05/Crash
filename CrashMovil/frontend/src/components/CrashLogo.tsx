...
import { COLORS, RADIUS, RED } from '../theme';
...
export function CrashLogoSVG({ size = 36, color = RED }: { size?: number; color?: string }) {
...
export function CrashLogo({ size = 36, color = RED }: CrashLogoProps) {
  return (
    <View
      style={{
        width: size,
...
export function CrashLogoFull({ size = 28 }: { size?: number }) {
  return (
    <View style={styles.container}>
      ...
      >
        <CrashLogoSVG size={size} color={RED} />
      </View>
      <View>
...
export function CrashLogoIcon({ size = 24, color }: { size?: number; color?: string }) {
  return (
    ...
    >
      <CrashLogoSVG size={size} color={color || RED} />
    </View>
  );
}
...
export function CrashLogoMark({ size = 40 }: { size?: number }) {
  return (
    ...
    >
      <CrashLogoSVG size={size * 0.8} color="#FFFFFF" />
    </View>
  );
}
