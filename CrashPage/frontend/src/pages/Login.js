...
import { Lock, Mail, Loader2, Shield, Activity } from "lucide-react";
      ...
      <aside className="hidden lg:flex lg:col-span-3 relative overflow-hidden border-r border-white/5">
        ...
        <div className="relative z-10 flex flex-col justify-between p-14 w-full">
          <div className="flex items-center gap-3">
            <div className="h-10 w-10 rounded-xl bg-red-500/15 border border-red-500/40 flex items-center justify-center shadow-[0_0_20px_rgba(239,68,68,0.28)] avatar-ring">
              <CrashLogo />
            </div>
            <div>
          ...
          <div className="flex items-center gap-4 text-[10px] uppercase tracking-[0.3em]">
            <span className="text-neutral-600 flex items-center gap-1.5">
              <Shield className="h-3 w-3" /> Encrypted · TLS 1.3
            </span>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={onSubmit} className="space-y-5" data-testid="login-form">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 hover:border-white/20 focus:border-emerald-500/60 focus:bg-white/10 focus:ring-1 focus:ring-emerald-500/20 outline-none rounded-xl pl-10 pr-3 py-3 text-sm transition-all"
            ...
            <button
              ...
              disabled={busy}
              type="submit"
              className="w-full bg-emerald-500 hover:bg-emerald-400 disabled:opacity-50 disabled:cursor-not-allowed text-black font-semibold rounded-xl px-4 py-3 transition-all flex items-center justify-center gap-2 shadow-[0_0_30px_rgba(16,185,129,0.25)] hover:shadow-[0_0_40px_rgba(16,185,129,0.35)] hover-lift"
            >
              {busy ? <Loader2 className="h-4 w-4 animate-spin" /> : null}
              {busy ? "Verificando credenciales…" : "Acceder al Centro de Mando"}
            </button>
          </form>
