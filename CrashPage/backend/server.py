...
# =============================================================================
# Collaborative incident log
# =============================================================================
@api_router.get("/incidents/{incident_id}/log")
async def incident_log(incident_id: str, _: dict = Depends(get_current_user)):
...
@api_router.post("/incidents/{incident_id}/log")
async def add_incident_log(
    incident_id: str, payload: IncidentLogPayload, user: dict = Depends(get_current_user),
):
